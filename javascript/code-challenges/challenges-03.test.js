...
const typeNum = (arr) => {
  // Solution code here...
  let typeNumFunct = arr.filter(Number);
  return typeNumFunct;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let containsAndFunct = arr.filter( element => element.includes('and'));
  return containsAndFunct;
};
...
const oddValues = (arr) => {
  // Solution code here...
  let oddValuesFunct = arr.filter(n => n % 2 === 1);
  return oddValuesFunct;
};
